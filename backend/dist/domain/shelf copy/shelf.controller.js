...
const create_shelf_dto_1 = require("../shelf/dto/create-shelf.dto");
...
let ShelfController = class ShelfController {
    ...
    getShelf(id) {
        return this.shelfService.getById(id);
    }
    createShelf(CreateShelfDto) {
        return this.shelfService.createOrder(CreateShelfDto);
    }
};
__decorate([
    (0, common_1.Get)(''),
...
], ShelfController.prototype, "getShelf", null);
__decorate([
    (0, common_1.Post)(),
